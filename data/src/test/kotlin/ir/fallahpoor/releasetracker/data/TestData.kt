...
object TestData {
    ...
    val RELEASE_TRACKER = Library(LIBRARY_NAME_1, LIBRARY_URL_1, LIBRARY_VERSION_1)
    ...
    val COIL = Library(LIBRARY_NAME_2, LIBRARY_URL_2, LIBRARY_VERSION_2)

    val TIMBER = Library("Timber", "https://github.com/JakeWharton/timber", "4.7")
